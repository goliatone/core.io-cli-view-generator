...
function makeGUISchema(schemas) {
    ...
    schemas = schemas.map(schema => {
        ...
        group.fields = iterator(schema.properties, (prop, key) => {
            ...
            makeElement(field, prop, schema.definitions);
    ...
    require('./task-write')('./debug-schema-gui.json', out);
...
function makeElement(field, prop) {
    let element;
    console.log('make element: %s %s', field.name, prop.type);
